...
WHERE
    "CREDIT_PURCHASE".created_at >= '2024-12-01 00:00:00'
    AND "CREDIT_PURCHASE".created_at <= '2024-12-31 00:00:00'
GROUP BY "CREDIT_PACKAGE".name;

-- 6-4. 查詢：計算 12 月份總營收（使用 price_paid 欄位統計）
-- 顯示須包含以下欄位： 總營收
...
FROM "COURSE_BOOKING"
WHERE
    "COURSE_BOOKING".created_at >= '2024-12-01 00:00:00'
    AND "COURSE_BOOKING".created_at <= '2024-12-31 00:00:00'
    AND status != '課程已取消';
